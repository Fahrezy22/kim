    ...
    <div class="content">
      <div class="container">
        ...
        @endif
                ...
                <p class="card-text">
                    <form action="{{ route('public') }}" method="POST">
                        @csrf
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input class="form-control" type="text" name="kd_kim" placeholder="Kode kim" required>
                                        <label>Nama Kim</label>
                                        <input class="form-control" name="nama_kim" type="text" placeholder="nama" required>
                                        <label>Nama</label>
